...
fn clone() {
    ...
    assert_eq!(Some(KeyType::Ec), a1.public.key_type());
    assert_eq!(Some(KeyType::Ec), a1.private.key_type());
    assert_eq!(Some(KeyType::Ec), a2.public.key_type());
    assert_eq!(Some(KeyType::Ec), a2.private.key_type());
...
fn keygen_p256() {
    ...
    assert_eq!(Some(KeyType::Ec), key.public.key_type());
    assert_eq!(Some(KeyType::Ec), key.private.key_type());
...
fn keygen_ed25519() {
    ...
    assert_eq!(Some(KeyType::Ed), key.public.key_type());
    assert_eq!(Some(KeyType::Ed), key.private.key_type());
...
fn keygen_x25519() {
    ...
    assert_eq!(Some(KeyType::EcMont), key.public.key_type());
    assert_eq!(Some(KeyType::EcMont), key.private.key_type());
